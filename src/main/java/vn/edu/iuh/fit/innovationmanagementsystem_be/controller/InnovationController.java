...
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.requestDTO.InnovationFormDataRequest;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.InnovationFormDataResponse;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.InnovationResponse;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.InnovationStatisticsDTO;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.InnovationAcademicYearStatisticsDTO;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.UpcomingDeadlinesResponse;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.RecentActivitiesResponse;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.ActivityResponse;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.service.InnovationService;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.service.ActivityLogService;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.repository.ActivityLogRepository;
...
// @Tag(name = "Innovation Management", description = "Innovation management
// APIs")
...
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Innovation created and form
// data submitted successfully", content = @Content(schema =
...
// @Operation(summary = "Get My Innovations with Filter", description = "Get
// paginated list of all innovations for current user with filtering support")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "User innovations retrieved
// successfully", content = @Content(schema = @Schema(implementation =
// ResultPaginationDTO.class))),
// @ApiResponse(responseCode = "401", description = "Unauthorized")
// })
...
// @GetMapping("/innovations/my-innovations/by-status")
...
// Pageable pageable) {
// return
// ResponseEntity.ok(innovationService.getInnovationsByUserAndStatus(status,
// pageable));
// }
...
// @Operation(summary = "Get Innovation Statistics", description = "Get
// innovation statistics for current user (GIANG_VIEN role)")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Statistics retrieved
// successfully", content = @Content(schema = @Schema(implementation =
// InnovationStatisticsDTO.class))),
// @ApiResponse(responseCode = "401", description = "Unauthorized"),
// @ApiResponse(responseCode = "403", description = "Forbidden - GIANG_VIEN role
// required")
// })
// public ResponseEntity<InnovationStatisticsDTO> getInnovationStatistics() {
// InnovationStatisticsDTO statistics =
// innovationService.getInnovationStatisticsForCurrentUser();
...
// @Operation(summary = "Get Innovation Statistics by Academic Year",
// description = "Get innovation statistics grouped by academic year for current
// user")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Academic year statistics
// retrieved successfully", content = @Content(schema = @Schema(implementation =
// InnovationAcademicYearStatisticsDTO.class))),
// @ApiResponse(responseCode = "401", description = "Unauthorized"),
// @ApiResponse(responseCode = "403", description = "Forbidden - GIANG_VIEN role
// required")
// })
// public ResponseEntity<InnovationAcademicYearStatisticsDTO>
// getInnovationStatisticsByAcademicYear() {
...
// @Operation(summary = "Get Upcoming Deadlines", description = "Get upcoming
// deadlines from current active innovation round")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Upcoming deadlines
// retrieved successfully", content = @Content(schema = @Schema(implementation =
// UpcomingDeadlinesResponse.class))),
// @ApiResponse(responseCode = "401", description = "Unauthorized"),
...
// UpcomingDeadlinesResponse deadlines =
// innovationService.getUpcomingDeadlines();
...
// @Operation(summary = "Get Recent Activities", description = "Get recent
// activities for current user")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Recent activities retrieved
// successfully", content = @Content(schema = @Schema(implementation =
// RecentActivitiesResponse.class))),
// @ApiResponse(responseCode = "401", description = "Unauthorized")
// })
// public ResponseEntity<RecentActivitiesResponse> getRecentActivities(
// @Parameter(description = "Page number (0-based)") @RequestParam(defaultValue
// = "0") int page,
// @Parameter(description = "Page size") @RequestParam(defaultValue = "10") int
// size) {
// String userId = userService.getCurrentUserId();
// RecentActivitiesResponse activities =
// activityLogService.getRecentActivities(userId, page, size);
...
// @Operation(summary = "Get Recent Activities for Dashboard", description =
...
// @ApiResponse(responseCode = "401", description = "Unauthorized")
// })
// public ResponseEntity<RecentActivitiesResponse>
// getRecentActivitiesForDashboard(
// @Parameter(description = "Number of activities to return")
// @RequestParam(defaultValue = "5") int limit) {
// String userId = userService.getCurrentUserId();
// List<ActivityResponse> activities =
// activityLogService.getRecentActivitiesForDashboard(userId, limit);
...
// @Operation(summary = "Mark All Activities as Read", description = "Mark all
// activities as read for current user")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "All activities marked as
// read"),
// @ApiResponse(responseCode = "401", description = "Unauthorized")
// })
...
// @Operation(summary = "Get Unread Activities Count", description = "Get count
// of unread activities for current user")
// @ApiResponses(value = {
...
// @Operation(summary = "Mark Specific Activity as Read", description = "Mark a
// specific activity as read")
// @ApiResponses(value = {
