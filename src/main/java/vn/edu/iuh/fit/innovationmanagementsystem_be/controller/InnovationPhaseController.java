...
public class InnovationPhaseController {
        ...
        @GetMapping("/decision/{decisionId}/can-submit")
        ...
        public ResponseEntity<Boolean> canSubmitInnovation(
                ...
                boolean canSubmit = innovationPhaseService.canSubmitInnovation(decisionId);
                return ResponseEntity.ok(canSubmit);
        }

        // 10. Check if can review at department level
        @GetMapping("/decision/{decisionId}/can-review-department")
        ...
        public ResponseEntity<Boolean> canReviewAtDepartmentLevel(
                ...
                boolean canReview = innovationPhaseService.canReviewAtDepartmentLevel(decisionId);
                return ResponseEntity.ok(canReview);
        }

        // 11. Check if can review at university level
        @GetMapping("/decision/{decisionId}/can-review-university")
        ...
        public ResponseEntity<Boolean> canReviewAtUniversityLevel(
                ...
                boolean canReview = innovationPhaseService.canReviewAtUniversityLevel(decisionId);
                return ResponseEntity.ok(canReview);
        }

        // 11. Check if can announce results
        @GetMapping("/decision/{decisionId}/can-announce")
        ...
        public ResponseEntity<Boolean> canAnnounceResults(
                ...
                boolean canAnnounce = innovationPhaseService.canAnnounceResults(decisionId);
