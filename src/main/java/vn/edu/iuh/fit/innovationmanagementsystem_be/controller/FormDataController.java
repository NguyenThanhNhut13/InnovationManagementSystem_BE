...
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.requestDTO.FormDataRequest;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.requestDTO.UpdateFormDataRequest;
// import
// vn.edu.iuh.fit.innovationmanagementsystem_be.domain.responseDTO.FormDataResponse;
...
// @Operation(summary = "Create Form Data", description = "Create a new form
// data")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Form Data created
// successfully", content = @Content(schema = @Schema(implementation =
// FormDataResponse.class))),
// @ApiResponse(responseCode = "400", description = "Invalid request data")
// })
// public ResponseEntity<FormDataResponse> createFormData(
// @Parameter(description = "Form data creation request", required = true)
...
// @Operation(summary = "Create Multiple Form Data", description = "Create
// multiple form data")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Multiple Form Data created
// successfully", content = @Content(schema = @Schema(implementation =
// List.class))),
// @ApiResponse(responseCode = "400", description = "Invalid request data")
// })
// public ResponseEntity<List<FormDataResponse>> createMultipleFormData(
// @Parameter(description = "List of form data creation requests", required =
// true) @Valid @RequestBody List<FormDataRequest> requests) {
// List<FormDataResponse> responses =
// formDataService.createMultipleFormData(requests);
...
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Form Data updated
// successfully", content = @Content(schema = @Schema(implementation =
// FormDataResponse.class))),
// @ApiResponse(responseCode = "400", description = "Invalid request data")
// })
// public ResponseEntity<FormDataResponse> updateFormData(
// @Parameter(description = "Form data ID", required = true) @PathVariable
// String id,
// @Parameter(description = "Form data update request", required = true) @Valid
// @RequestBody UpdateFormDataRequest request) {
...
// @Operation(summary = "Update Multiple Form Data", description = "Update
// multiple form data")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Multiple Form Data updated
// successfully", content = @Content(schema = @Schema(implementation =
// List.class))),
// @ApiResponse(responseCode = "400", description = "Invalid request data")
// })
// public ResponseEntity<List<FormDataResponse>> updateMultipleFormData(
// @Parameter(description = "List of form data update requests", required =
// true) @Valid @RequestBody List<FormDataRequest> requests) {
// List<FormDataResponse> responses =
// formDataService.updateMultipleFormData(requests);
// return ResponseEntity.ok(responses);
// }
...
// @Operation(summary = "Get Form Data by Id", description = "Get form data by
// id")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Form Data retrieved
// successfully", content = @Content(schema = @Schema(implementation =
// FormDataResponse.class))),
// @ApiResponse(responseCode = "400", description = "Invalid request data")
// })
...
// @Operation(summary = "Get Form Data by Innovation Id", description = "Get
// form data by innovation id")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Form Data retrieved
// successfully", content = @Content(schema = @Schema(implementation =
// List.class))),
...
// @Operation(summary = "Get Form Data by Template Id", description = "Get form
// data by template id")
// @ApiResponses(value = {
// @ApiResponse(responseCode = "200", description = "Form Data retrieved
// successfully", content = @Content(schema = @Schema(implementation =
...
// @Parameter(description = "Template ID", required = true) @PathVariable String
// templateId) {
// List<FormDataResponse> responses =
// formDataService.getFormDataByTemplateId(templateId);
// return ResponseEntity.ok(responses);
// }
...
// @Operation(summary = "Get Form Data With Form Fields", description = "Get
...
// templateId) {
// List<FormDataResponse> responses =
// formDataService.getFormDataWithFormFields(innovationId, templateId);
// return ResponseEntity.ok(responses);
// }
// }