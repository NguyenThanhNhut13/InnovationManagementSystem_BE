...
public interface FormTemplateMapper {
    ...
    @Mapping(target = "templateContent", source = "templateContent", qualifiedByName = "decodeTemplateContent")
    ...
    @Named("decodeTemplateContent")
    default String decodeTemplateContent(String encodedContent) {
        return Base64Utils.decode(encodedContent);
    }
}
