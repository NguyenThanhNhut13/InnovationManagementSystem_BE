...
public class UserController {
    ...
    // @Operation(summary = "Get All Users", description = "Get paginated list of
    ...
    // @Parameter(description = "Filter specification for users") @Filter
    ...
    // Pageable pageable) {
    // return ResponseEntity.ok(userService.getUsersByStatusWithPagination(status,
    // pageable));
    // }
    ...
    // getUsersByRoleWithPagination(@Filter @PathVariable String roleId,
    // Pageable pageable) {
    // return ResponseEntity.ok(userService.getUsersByRoleWithPagination(roleId,
    // pageable));
    // }
    ...
    // public ResponseEntity<ResultPaginationDTO>
    // getUsersByDepartmentWithPagination(
    // @Filter @PathVariable String departmentId,
    // Pageable pageable) {
    // return
    // ResponseEntity.ok(userService.getUsersByDepartmentWithPagination(departmentId,
    // pageable));
    // }
    ...
    // Pageable pageable) {
    // return
    // ResponseEntity.ok(userService.searchUsersByFullNameOrEmailOrPersonnelId(searchTerm,
    // pageable));
    // }
