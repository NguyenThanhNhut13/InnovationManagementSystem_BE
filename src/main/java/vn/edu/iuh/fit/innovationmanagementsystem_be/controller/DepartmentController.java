...
public class DepartmentController {
        ...
        // @Operation(summary = "Create Department", description = "Create a new
        // department")
        // @ApiResponses(value = {
        ...
        // @Parameter(description = "Department creation request", required = true)
        ...
        // @Operation(summary = "Get Department User Statistics", description = "Get
        // department user statistics")
        // @ApiResponses(value = {
        // @ApiResponse(responseCode = "200", description = "Department user statistics
        ...
        // {
        // List<DepartmentResponse> statistics =
        // departmentService.getDepartmentUserStatistics();
        ...
        // @Operation(summary = "Get Department User Statistics by Department ID",
        // description = "Get department user statistics by department ID")
        // @ApiResponses(value = {
        // @ApiResponse(responseCode = "200", description = "Department user statistics
        // retrieved successfully", content = @Content(schema = @Schema(implementation =
        // DepartmentResponse.class))),
        ...
        // @Parameter(description = "Department ID", required = true) @PathVariable
        // String id) {
        // DepartmentResponse statistics =
        // departmentService.getDepartmentUserStatisticsById(id);
        // return ResponseEntity.ok(statistics);
        // }
        ...
        // @Operation(summary = "Search Departments By Keyword With Pagination",
        // description = "Search departments by keyword with pagination")
        // @ApiResponses(value = {
        ...
        // searchDepartmentsByKeywordWithPagination(
        // @Parameter(description = "Search keyword", required = true) @RequestParam
        // String keyword,
        // @Parameter(description = "Pagination parameters") Pageable pageable) {
        // return
        // ResponseEntity.ok(departmentService.searchDepartmentsByKeywordWithPagination(keyword,
        // pageable));
        // }
        ...
        // @Operation(summary = "Get all User in Department", description = "Get all
        // users in department")
        // @ApiResponses(value = {
        ...
        // String id,
        // @Parameter(description = "Pagination parameters") Pageable pageable) {
        // return ResponseEntity.ok(departmentService.getAllUserInDepartment(id,
        // pageable));
        // }

        // // 9. Lấy danh sách người dùng đang hoạt động trong phòng ban
        // @GetMapping("/departments/{id}/users/active")
        // @ApiMessage("Lấy danh sách người dùng đang hoạt động trong phòng ban thành
        // công")
        // @Operation(summary = "Get Active User in Department", description = "Get
        ...
        // String id,
        // @Parameter(description = "Pagination parameters") Pageable pageable) {
        // return ResponseEntity.ok(departmentService.getActiveUserInDepartment(id,
        // pageable));
        // }

        // // 10. Lấy danh sách người dùng không hoạt động trong phòng ban
        // @GetMapping("/departments/{id}/users/inactive")
        // @ApiMessage("Lấy danh sách người dùng không hoạt động trong phòng ban thành
        // công")
        // @Operation(summary = "Get Inactive User in Department", description = "Get
        // inactive users in department")
        // @ApiResponses(value = {
        ...
        // String id,
        // @Parameter(description = "Pagination parameters") Pageable pageable) {
        // return ResponseEntity.ok(departmentService.getInactiveUserInDepartment(id,
        // pageable));
        // }
        ...
        // @Operation(summary = "Remove User from Department", description = "Remove
        // user from department")
        // @ApiResponses(value = {
        // @ApiResponse(responseCode = "200", description = "User removed from
