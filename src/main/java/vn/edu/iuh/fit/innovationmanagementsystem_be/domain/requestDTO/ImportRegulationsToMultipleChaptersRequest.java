...
@NoArgsConstructor
@AllArgsConstructor
public class ImportRegulationsToMultipleChaptersRequest {

    @NotBlank(message = "ID quyết định không được để trống")
    private String innovationDecisionId;

    @NotEmpty(message = "Danh sách chương và điều khoản không được để trống")
    @Valid
    private List<ChapterRegulations> chapterRegulations;

    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    public static class ChapterRegulations {
